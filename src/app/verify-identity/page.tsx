...
export default function VerifyIdentityPage() {
  ...
  if (isPageLoading) return <div className="flex-1 bg-white min-h-screen flex flex-col items-center justify-center"><Loader2 className="w-8 h-8 animate-spin text-[#8B0000]" /></div>
      ...
      <main className="flex-1 flex flex-col p-8">
        {profile?.is_verified ? (
          <div className="flex-1 flex flex-col items-center justify-center space-y-10 animate-in zoom-in-95 duration-500">
            ...
            <Button className="w-full h-16 rounded-full bg-[#8B0000] text-white font-bold uppercase tracking-widest text-sm shadow-xl active:scale-95 transition-all mt-auto" onClick={() => router.push('/profile')}>Back to Profile</Button>
          </div>
        ) : (
          <>
            {step === 'instructions' && (
              <div className="flex-1 flex flex-col space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex flex-col items-center text-center space-y-6 pt-10">
                  <div className="w-24 h-24 bg-red-50 rounded-[2.5rem] flex items-center justify-center"><ShieldCheck className="w-12 h-12 text-[#8B0000]" /></div>
            ...
            {step === 'capture' && capturedImage && (
              <div className="flex-1 flex flex-col space-y-8 animate-in zoom-in-95 duration-300">
                ...
                <div className="flex flex-col gap-4 mt-auto">
                  <Button className="w-full h-16 rounded-full bg-[#8B0000] text-white font-bold uppercase tracking-widest text-sm shadow-xl active:scale-95 transition-all" onClick={runVerification} disabled={loading}>Submit for Analysis</Button>
