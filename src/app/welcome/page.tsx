...
/**
 * @fileOverview Cinematic Welcome Page v2.4.
 * Updated: Reduced button sizes for a refined native look.
 */
        ...
        <div className="w-full max-w-xs space-y-6">
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-8 duration-700">
            <Button 
              ...
              className="w-full h-16 rounded-[2rem] bg-white text-black hover:bg-white/90 font-black text-[10px] tracking-[0.2em] uppercase shadow-[0_20px_50px_rgba(255,255,255,0.1)] active:scale-95 transition-all"
            >
              <Mail className="w-4 h-4 mr-3 text-[#8B0000]" /> Continue with Email
            </Button>

            <Button 
              disabled={loading}
              onClick={handleGoogleLogin}
              className="w-full h-16 rounded-[2rem] bg-white/10 backdrop-blur-2xl border border-white/20 text-white hover:bg-white/20 font-black text-[10px] tracking-[0.2em] uppercase active:scale-95 transition-all"
            >
